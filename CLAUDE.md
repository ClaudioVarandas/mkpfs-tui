...
(pack / inspect / verify / tree / unpack PlayStation PFS images + build raw dumps to exFAT). Feature-complete;
...
- `screens/` — the six views (Inspect/Verify/Tree subclass `ReadView`; Pack, Unpack, and BuildExfat are plain
